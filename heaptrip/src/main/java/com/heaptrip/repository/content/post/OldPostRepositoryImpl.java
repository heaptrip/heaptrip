...
@Deprecated
@Service(OldPostRepository.SERVICE_NAME)
public class OldPostRepositoryImpl implements OldPostRepository {

	private static final Logger logger = LoggerFactory.getLogger(OldPostRepositoryImpl.class);
