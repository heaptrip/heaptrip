...
public class PostController {
	...
	public String savePost(@ModelAttribute("post") PostView view) {
	...
	public String uploadImage(MultipartHttpServletRequest multipart, RedirectAttributes redirect,
		...
		for (MultipartFile file : files.values()) {
			logger.info("Received order: {}, size {}", file.getOriginalFilename(), file.getSize());
			imageId = postRepository.saveImage(file.getInputStream(), file.getOriginalFilename());
			break;
		}
