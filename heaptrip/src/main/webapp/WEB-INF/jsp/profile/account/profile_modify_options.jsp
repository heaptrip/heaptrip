    ...
    <div id="container">
        <div id="contents">
            ...
            <article id="article" class="deteil edit">
                ...
                <%--<h2 class="people_title">Реклама</h2>--%>
                <%--<div class="right">--%>
                <%--<a class="button" func="16">Сохранить</a>--%>
                <%--</div>--%>
                <%--</div>--%>
                <%--<div class="left">--%>
                <%--<ul>--%>
                <%--<li><input type="checkbox"><label>Клубы</label></li>--%>
                <%--<li><input type="checkbox"><label>Компании</label></li>--%>
                <%--<li><input type="checkbox"><label>Турфирмы</label></li>--%>
                <%--</ul>--%>
                <%--</div>--%>
                <%--</div>--%>
                ...
                <div class="new_email form_new_data">
